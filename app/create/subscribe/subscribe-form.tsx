...
export default function SubscribeForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/mailerlite", {
        ...
        body: JSON.stringify({
          email: trimmedEmail,
          source: "bedo_create_subscribe_page",
        }),
      })
  ...
  return (
    <div className="theme-create min-h-screen bg-background relative flex flex-col overflow-hidden">
      {/* Background grids and glows */}
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,oklch(0.72_0.19_50_/_0.08)_0%,transparent_40%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_85%_80%,oklch(0.72_0.19_50_/_0.04)_0%,transparent_45%)]" />
        <div 
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-base leading-relaxed md:text-lg">
                    Weekly raw ideas, UI/UX design assets, and practical AI workflows. Straight from my private Obsidian notes, direct to your inbox.
                  </p>
                </div>
                ...
                <div className="space-y-3.5 text-sm md:text-base border-t border-b border-border/50 py-5">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">
                      <strong className="text-foreground font-semibold">Behind the Scenes:</strong> Get access to Figma files, code snippets, and prompt templates before they make it to YouTube.
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">
                      <strong className="text-foreground font-semibold">Zero Fluff:</strong> Clean, actionable 5-minute reads. No spam, unsubscribe with a single click.
                    </span>
                  </div>
                </div>
              ...
              <div className="text-center py-6 space-y-6 animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm md:text-base max-w-sm mx-auto">
                    Thanks for subscribing to <strong className="text-foreground font-semibold">The Draft Bin</strong>. Keep an eye on your inbox for the next edition.
                  </p>
                </div>
                <div className="pt-2">
