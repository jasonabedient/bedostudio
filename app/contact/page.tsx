...
export default async function ContactPage() {
  ...
  // Determine theme based on host
  let themeClass = "theme-create"
  if (host.includes("financial")) themeClass = "theme-financial"
  if (host.includes("adventure")) themeClass = "theme-adventure"
